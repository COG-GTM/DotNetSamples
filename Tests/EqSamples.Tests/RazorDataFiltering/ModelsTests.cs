...
using RazorProduct = RazorDataFilter::EqDemo.Models.Product;
using RazorCategory = RazorDataFilter::EqDemo.Models.Category;
using RazorOrderDetail = RazorDataFilter::EqDemo.Models.OrderDetail;
using RazorShipper = RazorDataFilter::EqDemo.Models.Shipper;
using RazorSupplier = RazorDataFilter::EqDemo.Models.Supplier;
